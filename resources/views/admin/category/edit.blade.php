        ...
        <div class="card bg-gradient-dark mt-3">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('category#update') }}" method="POST">
                    ...
                    <input type="hidden" name="categoryId" value={{ $updateCategory->id }}>

                    <div class="form-group">
                        <label for="">Category Name</label>
                        <input value="{{ old('categoryName', $updateCategory->title) }}" name="categoryName" type="text"
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="description" cols="20" rows="5" placeholder="Enter Description..." class="form-control">{{ old('description', $updateCategory->description) }}</textarea>
                        @error('description')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                                ...
                                <td>
                                    <div class="table-data-feature">
                                        <a href="{{ route('category#edit', $c->id) }}">
                                            <button class="item bg-gradient-purple" data-toggle="tooltip" data-placement="top"
                                                title="Edit">
